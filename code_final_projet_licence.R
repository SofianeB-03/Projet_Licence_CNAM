...
## Les dataframes dont on à besoin pour effectuer une regression simple lineaire vérification de leur structure

print( str(data_avec_valeurs_manquantes) )

print( str(data_sans_valeurs_manquantes) )
...
# Utiliser broom::glance pour extraire les statistiques globales
...
# Ajuster un modèle de régression linéaire avec na imputé
